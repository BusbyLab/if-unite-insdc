...
This separation also facilitates the use of both 5.8S and ITS2 for taxonomic assignment, as demonstrated in [Heeger *et al*. 2019](https://doi.org/10.1111/2041-210X.13266). They found that ITS1 and ITS2 sequences alone can fail to obtain taxonomic assignments at even high ranks (e.g., kingdom, phylum, and class) when assignment reference files are incomplete (as they always are).
