...
**These split references are found in the `its1`, `5.8s`, and `its2` subdirectories within the `04-trim` directory. Use files following the `fun.[ITS1/5_8S/ITS2].fasta.gz` or `euk.5_8S.fasta.gz` pattern as taxonomic references. The files in the `03-extract` subdirectory are outputs of [`ITSx`](https://microbiology.se/software/itsx/) and available for inspection.**
